...
final class PolishTranslationTest extends TestCase
{
    ...
    public function test_id_card_translation_keys_exist(): void
    {
        ...
        $this->assertSame('Numer dowodu osobistego musi składać się dokładnie z 9 znaków.', trans('numerik::validation.id_card.invalid_length', $attr));
    ...
    public function test_passport_translation_keys_exist(): void
    {
        ...
        $this->assertSame('Numer paszportu musi składać się dokładnie z 9 znaków.', trans('numerik::validation.passport.invalid_length', $attr));
    ...
    public function test_vat_eu_translation_keys_exist(): void
    {
        ...
        $this->assertSame('Numer VAT-EU musi zawierać dokładnie 10 cyfr po prefiksie PL.', trans('numerik::validation.vat_eu.invalid_length', $attr));
    ...
    public function test_nrb_translation_keys_exist(): void
    {
        ...
        $this->assertSame('NRB musi składać się dokładnie z 26 cyfr.', trans('numerik::validation.nrb.invalid_length', $attr));
    ...
    public function test_iban_translation_keys_exist(): void
    {
        ...
        $this->assertSame('IBAN musi zawierać dokładnie 26 cyfr po prefiksie PL.', trans('numerik::validation.iban.invalid_length', $attr));
