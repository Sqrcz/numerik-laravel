...
final class IdCardRule implements ValidationRule
{
    ...
    {
        $identifier = new IdCardIdentifier(strict: $this->strict);
        ...
        if ($result->isFailed()) {
            ...
            $key = "numerik::validation.id_card.{$reason}";
            ...
            $fail(Lang::has($key) ? $key : 'numerik::validation.id_card.default')
