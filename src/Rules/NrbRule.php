...
final class NrbRule implements ValidationRule
{
    ...
    {
        $identifier = new NrbIdentifier(strict: $this->strict);
        ...
        if ($result->isFailed()) {
            ...
            $key = "numerik::validation.nrb.{$reason}";
            ...
            $fail(Lang::has($key) ? $key : 'numerik::validation.nrb.default')
