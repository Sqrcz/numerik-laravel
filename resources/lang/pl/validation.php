...
return [
    ...
    'id_card' => [
        ...
        'invalid_length'     => 'Numer dowodu osobistego musi składać się dokładnie z 9 znaków.',
    ...
    'passport' => [
        ...
        'invalid_length'     => 'Numer paszportu musi składać się dokładnie z 9 znaków.',
        'invalid_characters' => 'Pole :attribute zawiera niedozwolone znaki.',
        'invalid_checksum'   => 'Cyfra kontrolna w polu :attribute jest nieprawidłowa.',
    ],
    ...
    'vat_eu' => [
        ...
        'invalid_length'     => 'Numer VAT-EU musi zawierać dokładnie 10 cyfr po prefiksie PL.',
    ...
    'nrb' => [
        ...
        'invalid_length'     => 'NRB musi składać się dokładnie z 26 cyfr.',
        'invalid_characters' => 'Pole :attribute może zawierać wyłącznie cyfry.',
    ...
    'iban' => [
        ...
        'invalid_length'     => 'IBAN musi zawierać dokładnie 26 cyfr po prefiksie PL.',
        'invalid_format'     => 'Pole :attribute musi zaczynać się od prefiksu kraju PL.',
        'invalid_characters' => 'Pole :attribute może zawierać wyłącznie cyfry po prefiksie PL.',
